...
date: 2023-05-24T09:39:58+05:30
draft: false
...
Hibernate ORM with Panache supports the Active Record Pattern and Repository Pattern to simplifyJPA usage.
...
The transparent integration with Testcontainers helped us build and test the Quarkus applications simpler
